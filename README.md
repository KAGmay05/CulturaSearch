...
rag_demo.py         # Ejemplos de uso
RAG_SETUP.py        # Guía de instalación
RAG_REFERENCE.py    # Referencia rápida
```
...
| Backend | Velocidad | Requisitos | Precisión |
|---------|-----------|-----------|-----------|
| Ollama | ⚡⚡⚡ Rápido | GPU (opcional) | Alta |
| OpenAI | ⚡⚡ Rápido | API Key | Muy Alta |
| HuggingFace | ⚡ Lento | GPU recomendado | Alta |
